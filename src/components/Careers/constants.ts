export const description = [
  'Technology expands possibilities. RCM Labs is a factory of possibilities. We aspire to help millions empower and express the genius within them. We believe talent is a renewable resource. We are building the world’s first Play>>Learn>>Earn (PLE) model within a highly-engaging blockchain game to expand possibilities and move beyond the limitations of 200+ years old practices.',

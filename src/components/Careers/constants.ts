export const description = [
  'Technology expands possibilities. RCM Labs is a factory of possibilities. We aspire to help millions empower and express the genius within them. We  believe talent is a renewable resource. We are building the world’s first Play>Learn>Earn model within a highly engaging blockchain game to expand possibilities and move beyond the limitations of 200+ years old practices.',
  ...
  "Web3 infrastructure is maturing and there has never been a better time to build in this exponentially growing space.We are looking for creative builders, doers and makers.",
  "RCM Labs has a collaborative culture with flexibility and benefits to encourage creativity, healthy lifestyle, continuous learning and strong professional development, with 200 % focus on delivery."
]

...
export const TOP_CATS = [
  ...
  '/images/ple/top/cat (4).png',
  '/images/ple/top/cat (5).png',
  '/images/ple/top/cat (6).png',
  '/images/ple/top/cat (7).png',
  '/images/ple/top/cat (8).png',
  '/images/ple/top/cat (9).png'
];
